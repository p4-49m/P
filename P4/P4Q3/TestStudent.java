...
public class TestStudent {
    public static void main(String[]args){
        ...
        System.out.println("Quiz Contribution Score: " + stu1.getAverageScore() * Student.getQuizContribution());

        System.out.println("\nID: " + stu2.getStudentID());
        System.out.println("-".repeat(30));
        ...
        System.out.println("Quiz Contribution Score: " + stu2.getAverageScore() * Student.getQuizContribution());
    }
